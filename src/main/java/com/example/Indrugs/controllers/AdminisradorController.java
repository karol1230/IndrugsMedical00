...
public class AdminisradorController {
    ...
    public class PQRSController {
        ...
        public List<PQRSDTO> listarTodos() {
            return pqrsService.listarTodo();
        }

        @PutMapping("/{id}/responder")
        public String responder(@PathVariable Long id, @RequestBody String respuesta) {
            pqrsService.responder(id, respuesta);
            return "Respuesta registrada correctamente";
        }

        @PutMapping("/{id}/estado")
        public String cambiarEstado(@PathVariable Long id, @RequestBody String estado) {
            pqrsService.cambiarEstado(id, estado);
            return "Estado actualizado";
        }
        @GetMapping("/administrador/pqrs")
        public String listarTodasPQRS(Model model) {
            model.addAttribute("listaPQRS", pqrsService.listarTodas());
            return "listar"; // pqrs_listar.html
        }
